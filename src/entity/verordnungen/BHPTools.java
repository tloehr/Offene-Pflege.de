...
public class BHPTools {
    ...
    public static int erzeugen(EntityManager em, Verordnung verordnung) throws Exception {
        return erzeugen(em, verordnung, null);
    }
     ...
     */
    public static int erzeugen(EntityManager em, Verordnung verordnung, Date zeit) throws Exception {
