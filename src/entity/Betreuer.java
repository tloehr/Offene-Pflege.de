...
public class Betreuer implements Serializable {
    ...
    public Betreuer(Long betrID) {
        this.betrID = betrID;
    }

    public Betreuer(Long betrID, String anrede, String name, String vorname, String strasse, String plz, String ort, String tel, String privat, String fax) {
        this.betrID = betrID;
        this.anrede = anrede;
        this.name = name;
