...
//            + "<br/>http://www.offene-pflege.de</font>\n";
    ...
    public static final Icon icon32apply = new ImageIcon(SYSConst.class.getResource("/artwork/32x32/apply.png"));
    public static final Icon icon32empty = new ImageIcon(SYSConst.class.getResource("/artwork/32x32/empty.png"));
...
//    public static final Icon icon22edit1Pressed = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/edit1_pressed.png"));
    ...
    public static final Icon icon16infored = new ImageIcon(SYSConst.class.getResource("/artwork/16x16/infored.png"));
...
//    public static final Icon icon22viewPressed = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/bw/viewmag-selected.png"));
    ...
    public static final Icon icon22usbpen = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/usbpen.png"));
    public static final Icon icon22usbpenred = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/usbpen-red.png"));
    public static final Icon icon22usbpengreen = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/usbpen-green.png"));
    public static final Icon icon22RedFlag = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/flag.png"));
    public static final Icon icon222rightArrow = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/2rightarrow.png"));
    public static final Icon icon222leftArrow = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/2leftarrow.png"));
    ...
    public static final Icon icon22encrypted = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/encrypted.png"));
    public static final Icon icon22decrypted = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/decrypted.png"));
