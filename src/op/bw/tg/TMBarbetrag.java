...
//                System.out.println(zeilensaldo);
        ...
        if (r + 1 == this.offset) { // Geht nur, wenn der Offset != 0 ist.
            switch (c + 1) {
                case 1: {
                    result = SYSCalendar.addDate(this.von, -1);
                    break;
                }//SYSCalendar.printGermanStyleShort(SYSCalendar.addDate(this.von, -1)); break;} // Von - 1 Tag
                case 2: {
            ...
            try {
                ...
                switch (c + 1) {
                    case 1: {
                        result = rs.getDate("BelegDatum");
                        break;
                    }
                    case 2: {
                        result = rs.getString("Belegtext");
                        break;
                    }
                    case 3: {
                        result = rs.getDouble("Betrag");
                        break;
                    }
                    case 4: {
                        result = new Double(zeilensaldo + rs.getDouble("Betrag"));
                        break;
                    }
                    case 5: {
                        result = rs.getLong("TGID");
                        break;
                    }
                    case 6: {
                        result = rs.getLong("_cancel");
                        break;
                    }
                    default: {
                        result = "";
