    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            case COL_TXT: {
                ...
                html += "<b>" + planung.getInterventionSchedule().get(row).getIntervention().getBezeichnung() + "</b> (" + planung.getInterventionSchedule().get(row).getDauer().toPlainString() + " " + SYSTools.xx("misc.msg.Minutes") + ")";
