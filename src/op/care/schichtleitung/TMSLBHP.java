...
public class TMSLBHP
    ...
    public Class getColumnClass(int c){
        switch (c){
            ...
            case COL_BEZEICHNUNG:{ return String.class;}
            //case COL_ZUSATZ:{ return String.class;}
            case COL_ZEIT:{ return String.class;}
            case COL_STATUS:{ return Integer.class;}
            case COL_DOSIS:{ return Double.class;}
            case COL_UKENNUNG:{ return String.class;}
            case COL_BEMPLAN:{ return String.class;}
            case COL_BEMBHP:{ return String.class;}
            case COL_BHPID:{ return Long.class;}
            case COL_BHPPID:{ return Long.class;}
            case COL_MDATE:{ return Long.class;}
            case COL_VERID:{ return Long.class;}
            case COL_DAFID:{ return Long.class;}
            case COL_SITID:{ return Long.class;}
            case COL_REICHTVORRAT:{ return Boolean.class;}
            case COL_BISPACKENDE:{ return Boolean.class;}
            case COL_SALDO:{ return Double.class;}
            case COL_PACKEINHEIT:{ return Integer.class;}
            case COL_ABDATUM:{ return Long.class;}
        }
        return String.class;
    }
...
//                    break;
//                }
                case COL_DOSIS : {result = rs.getDouble("Dosis"); break;}
                case COL_ZEIT : {
                ...
                case COL_STATUS : {result = rs.getInt("Status"); break;}
                case COL_UKENNUNG : {
                ...
                case COL_BEMBHP : {result = rs.getString("bemerkung"); break;}
                case COL_BHPID : {result = rs.getLong("BHPID"); break;}
                case COL_BHPPID : {result = rs.getLong("BHPPID"); break;}
                case COL_MDATE : {result = rs.getTimestamp("_mdate").getTime(); break;}
                case COL_VERID : {result = rs.getLong("VerID"); break;}
                case COL_DAFID : {result = rs.getLong("DafID"); break;}
                case COL_SITID : {result = rs.getLong("SitID"); break;}
                case COL_SALDO : {result = rs.getDouble("Saldo"); break;}
                case COL_PACKEINHEIT : {result = rs.getInt("PackEinheit"); break;}
                ...
                case COL_ABDATUM : {result = rs.getTimestamp("AbDatum").getTime(); break;}
                default : {result = "";}
            }
        } catch (SQLException se){
            new DlgException(se);
