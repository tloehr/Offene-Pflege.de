INSERT INTO `homes` (`eid`, `name`, `str`, `zip`, `city`, `tel`, `fax`,`color`) VALUES ('home1', 'OPDE Haus', 'Strasse', '11111', 'Ort', '00000-00000', '00000-00000','3333ff');
...
INSERT INTO `users` (Vorname, Nachname, UKennung, STATUS, MD5PW, version) VALUES ('OPDE','Admin','admin',2,'notyet','0');
...
INSERT INTO `sysprops` (`K`, `V`, `UKennung`) VALUES('dbstructure','9',NULL);
