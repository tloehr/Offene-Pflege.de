...
//                        table.getDefaultCell().setBackgroundColor(null);
            ...
            protected void done() {
                ...
                try {
                    SYSFilesService.handleFile(((PDF) get()).getOutputFile(), Desktop.Action.OPEN);
...
//                    boolean bewohnerWechsel = !resID.equalsIgnoreCase(prescription.getResident().getId());
//
    ...
    public static String getAnnontationsAsHTML(Prescription prescription) {
        ...
        if (isAnnotationNecessary(prescription)) {
            ...
            for (ResInfo annotation : prescription.getAnnotations()) {
                ...
                result += annotation == null ? SYSTools.xx("misc.msg.noentryyet") : ResInfoService.getContentAsHTML(annotation);
