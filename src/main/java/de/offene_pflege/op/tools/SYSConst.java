...
//            + "<br/>http://www.offene-pflege.de</font>\n";
    ...
    public static final Icon icon22exec = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/exec.png"));
...
//    public static final Icon icon48ambulance2Pressed = new ImageIcon(SYSConst.class.getResource("/artwork/32x32/ambulance2_pressed.png"));
    ...
    public static final Icon icon22ledGrey = new ImageIcon(SYSConst.class.getResource("/artwork/22x22/ledgrey.png"));
    ...
    public static final String icon22singleIncident = "/artwork/22x22/single-incident.png";
    public static final String icon22intervalByDay = "/artwork/22x22/by-day.png";
    public static final String icon22intervalBySecond = "/artwork/22x22/by-second.png";
    public static final String icon22intervalNoConstraints = "/artwork/22x22/no-constraints.png";

    public static String fontawesome_info_circle = "/artwork/16x16/bw/info-circle.png";
    ...
    public static String icon22kzp = "/artwork/22x22/stopwatch.png";
