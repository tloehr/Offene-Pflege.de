...
package de.offene_pflege.op.care.bhp;
...
public class DlgDueToday extends JDialog {
    public DlgDueToday(Window owner, BHP bhp) {
        super(owner);
        initComponents();
        ...
        String content = "<html><head>\n" +
                ...
                "<p id=\"font16\">\n" +
                "Diese Verordnung ist besonders wichtig, weil sie nicht jeden Tag verabreicht wird. Bitte prüfe, ob Du sie <b>auch wirklich durchgeführt</b> hast.</p>\n" +
                "<p id=\"font14\">" +PrescriptionTools.getPrescriptionAsHTML(bhp.getPrescription(), false, false, true, false) + "</p>" +
                "</body></html>";
