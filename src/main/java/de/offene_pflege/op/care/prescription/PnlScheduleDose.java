...
//        jdcLDatum.setDate(new Date(Math.max(schedule.getLDatum().getTime(), SYSCalendar.startOfDay())));
    ...
    private void cbSunActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cbSunActionPerformed
    ...
    private void cbSatActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cbSatActionPerformed
        if (!(cbSun.isSelected() || cbSat.isSelected() || cbFri.isSelected() || cbThu.isSelected() || cbWed.isSelected() || cbTue.isSelected() || cbMon.isSelected())) {
            OPDE.getDisplayManager().addSubMessage(new DisplayMessage("nursingrecords.prescription.pnlscheduledose.error.atLeastOneWeekDay"));
            ((JCheckBox) evt.getSource()).setSelected(true);
        }
    ...
    private void cbFriActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cbFriActionPerformed
        if (!(cbSun.isSelected() || cbSat.isSelected() || cbFri.isSelected() || cbThu.isSelected() || cbWed.isSelected() || cbTue.isSelected() || cbMon.isSelected())) {
            OPDE.getDisplayManager().addSubMessage(new DisplayMessage("nursingrecords.prescription.pnlscheduledose.error.atLeastOneWeekDay"));
            ((JCheckBox) evt.getSource()).setSelected(true);
        }
    ...
    private void cbThuActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cbThuActionPerformed
        if (!(cbSun.isSelected() || cbSat.isSelected() || cbFri.isSelected() || cbThu.isSelected() || cbWed.isSelected() || cbTue.isSelected() || cbMon.isSelected())) {
            OPDE.getDisplayManager().addSubMessage(new DisplayMessage("nursingrecords.prescription.pnlscheduledose.error.atLeastOneWeekDay"));
            ((JCheckBox) evt.getSource()).setSelected(true);
        }
    ...
    private void cbWedActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cbWedActionPerformed
        if (!(cbSun.isSelected() || cbSat.isSelected() || cbFri.isSelected() || cbThu.isSelected() || cbWed.isSelected() || cbTue.isSelected() || cbMon.isSelected())) {
            OPDE.getDisplayManager().addSubMessage(new DisplayMessage("nursingrecords.prescription.pnlscheduledose.error.atLeastOneWeekDay"));
            ((JCheckBox) evt.getSource()).setSelected(true);
        }
    ...
    private void cbTueActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cbTueActionPerformed
        if (!(cbSun.isSelected() || cbSat.isSelected() || cbFri.isSelected() || cbThu.isSelected() || cbWed.isSelected() || cbTue.isSelected() || cbMon.isSelected())) {
            OPDE.getDisplayManager().addSubMessage(new DisplayMessage("nursingrecords.prescription.pnlscheduledose.error.atLeastOneWeekDay"));
            ((JCheckBox) evt.getSource()).setSelected(true);
        }
...
//            btnSave.setPanelEnabled(true);
//        } catch (NumberFormatException nfe) {
//            btnSave.setPanelEnabled(false);
//        }
