...
//                tbWeightControl.setPanelEnabled(true);
//                                tbWeightControl.setSelected(false);
            ...
            rbEndOfPackage.setEnabled(prescription.getResident().getCalcMediUPR1() && cmbMed.getModel().getSize() > 0);
        }
    }
...
//        tbWeightControl.setPanelEnabled(cmbMed.getModel().getSize() != 0);
//        tbWeightControl.setSelected(prescription.isWeightControl());
        ...
        rbEndOfPackage.setEnabled(prescription.getResident().getCalcMediUPR1() && cmbMed.getSelectedItem() != null);
...
//        String pzn = MedPackageTools.parsePZN(txtMed.getText());
    ...
    private void tblDosisMousePressed(MouseEvent evt) {//GEN-FIRST:event_tblDosisMousePressed
...
//        final Point screenposition = p2;
    ...
    private void reloadTable() {
        ...
        tblDosis.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
