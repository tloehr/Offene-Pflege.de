...
import de.offene_pflege.op.care.bhp.PnlBHP;
import de.offene_pflege.op.care.dfn.PnlDFN;
import de.offene_pflege.op.care.info.PnlInformation;
import de.offene_pflege.op.care.med.inventory.PnlInventory;
import de.offene_pflege.op.care.nursingprocess.PnlNursingProcess;
import de.offene_pflege.op.care.prescription.PnlPrescription;
import de.offene_pflege.op.care.reports.PnlReport;
import de.offene_pflege.op.care.sysfiles.PnlFiles;
import de.offene_pflege.op.care.values.PnlLiquidBalance;
import de.offene_pflege.op.care.values.PnlValues;
...
//            SYSTools.xx("nursingrecords.main.tab12")
    ...
    public String getInternalClassID() {
        return jtpPflegeakte.getSelectedComponent() instanceof CleanablePanel ? ((CleanablePanel) jtpPflegeakte.getSelectedComponent()).getInternalClassID() : "null";
    }
    ...
    public void switchResident(Resident res) {
        ...
        jtpPflegeakte.setEnabledAt(TAB_VORRAT, resident.getCalcMediUPR1());
    }
