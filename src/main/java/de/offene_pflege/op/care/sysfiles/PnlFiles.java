...
//        };
    ...
    private void tblFilesMousePressed(MouseEvent evt) {//GEN-FIRST:event_tblFilesMousePressed
        ...
        if (SwingUtilities.isRightMouseButton(evt)) {
            ...
            if (OPDE.getAppInfo().isAllowedTo(InternalClassACL.DELETE, internalClassID)) {
                ...
                itemPopupDelete.setEnabled(ResidentTools.isActive(resident) && singleRowSelected);
            }
    ...
    private void jspFilesComponentResized(ComponentEvent evt) {//GEN-FIRST:event_jspFilesComponentResized
