package de.offene_pflege.services.qdvs.spec14;
...
import de.offene_pflege.services.qdvs.spec14.schema.*;
 ...
 */
@Log4j2
public class QdvsService14 implements QdvsService {
    ...
    public String get_DAS_SPEZIFIKATION() {
        return "DAS_Pflege_Spezifikation_V01.4/02_XSD/interface_qs_data/das_interface.xsd";
    }

    @Override
    public String get_DAS_REGELN_CSV() {
        return "DAS_Pflege_Spezifikation_V01.4/03_Dokumentationsbogen/DAS_Plausibilitaetsregeln.csv";
    }
    ...
    @Override
      public String get_DESCRIPTION() {
          return "Spezifikation V01.4 - Stand 03.04.2020";
      }
...
//        log.debug(String.format("%d Wunden gefunden", liste_wunden.size()));
    ...
    private void einzug(DasQsDataType qsData, Resident resident) {
        ...
        if (NEUEINZUG == 1) { /** 87 */
            ...
            qsData.getEINZUGNACHKZ().setValue(0);
     ...
     *
     * @param resident
     * @return Properties mit den folgenden Schlüsseln
     * ("tumor","tetra","chorea","apallisch","parkinson","osteo","ms","demenz","diabetes"). Die Values sind jeweils true
     * oder false.
     */
