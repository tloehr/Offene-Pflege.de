...
public class QdvsService21 implements QdvsService {
    ...
    public String get_DAS_SPEZIFIKATION() {
        return "DAS_Pflege_Spezifikation_V02.1/02_XSD/interface_qs_data/das_interface.xsd";
    }

    @Override
    public String get_DAS_REGELN_CSV() {
        return "DAS_Pflege_Spezifikation_V02.1/03_Dokumentationsbogen/DAS_Plausibilitaetsregeln.csv";
    }
    ...
    public String get_DESCRIPTION() {
        return "Spezifikation V02.1 - Stand 01.01.2022";
    }
...
//        log.debug(String.format("%d Wunden gefunden", liste_wunden.size()));
        ...
        // Formalitäten
        /** SPEC20-60 */qsData.setDEKUBITUS(of.createDasQsDataTypeDEKUBITUS());
        /** SPEC20-61 */qsData.setDEKUBITUSSTADIUM(of.createDasQsDataTypeDEKUBITUSSTADIUM());
        /** SPEC20-62 */qsData.setDEKUBITUS1BEGINNDATUM(of.createDasQsDataTypeDEKUBITUS1BEGINNDATUM());
        /** SPEC20-63 */qsData.setDEKUBITUS1ENDEDATUM(of.createDasQsDataTypeDEKUBITUS1ENDEDATUM());
        /** SPEC20-64 */qsData.setDEKUBITUS1LOK(of.createDasQsDataTypeDEKUBITUS1LOK());
        /** SPEC20-65 */qsData.setDEKUBITUS2BEGINNDATUM(of.createDasQsDataTypeDEKUBITUS2BEGINNDATUM());
    ...
    private void einzug(DasQsDataType qsData, Resident resident) {
        ...
        /** 88 */qsData.setEINZUGNACHKZP(of.createDasQsDataTypeEINZUGNACHKZP());
        /** 89 */qsData.setEINZUGNACHKZPDATUM(of.createDasQsDataTypeEINZUGNACHKZPDATUM());
