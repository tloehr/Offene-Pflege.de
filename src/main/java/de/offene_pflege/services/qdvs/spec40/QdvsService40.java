package de.offene_pflege.services.qdvs.spec40;
...
import de.offene_pflege.services.qdvs.spec40.schema.*;
...
/**
 * Mit der Vesion 4.0 der Spezifikation wurde nur eine Änderung vorgenommen.
 * <ul>
 *     <li>beim BEWUSSTSEINSZUSTAND fallen schläfrig und wachkoma raus</li>
 * </ul>
 */
@Log4j2
public class QdvsService40 implements QdvsService {
    ...
    static final String SPECIFICATION = "V04"; // die Version der jeweilig eingereichten Datenstruktur, die zum Zeitpunkt der Verwendung gültig war.
    ...
    public String get_DAS_SPEZIFIKATION() {
        return "DAS_Pflege_Spezifikation_V04.0/02_XSD/interface_qs_data/das_interface.xsd";
    }

    @Override
    public String get_DAS_REGELN_CSV() {
        return "DAS_Pflege_Spezifikation_V04.0/03_Dokumentationsbogen/DAS_Plausibilitaetsregeln.csv";
    }
...
//    ResInfoType typeDemenz = ResInfoTypeTools.getByType(ResInfoTypeTools.TYPE_ORIENTATION);
     ...
     */
    @SneakyThrows
    public QdvsService40(AddTextListener textListener) {
        log.info(FigletFont.convertOneLine(get_DESCRIPTION()));
    ...
    public String get_DESCRIPTION() {
        return "Spezifikation V04.0 - Stand 01.01.2025";
    }
